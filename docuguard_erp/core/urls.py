...
urlpatterns = [
   ...
   # Log Aktivitas (3 halaman scope) - DAMAI
    path('log_aktivitas/', views.LogAktivitasListView.as_view(), name='log_aktivitas'),
    path('log_aktivitas/riwayat/', views.RiwayatUserListView.as_view(), name='riwayat_user'),
    path('log_aktivitas/<int:pk>/', views.DetailAktivitasView.as_view(), name='detail_aktivitas'),
    
    # Kategori - ARSAT
    path('kategori/', views.KategoriListView.as_view(), name='kategori_list'),
    path('kategori/tambah/', views.KategoriCreateView.as_view(), name='kategori_tambah'),
    path('kategori/<int:pk>/', views.KategoriDetailView.as_view(), name='kategori_detail'),
    path('kategori/<int:pk>/edit/', views.KategoriUpdateView.as_view(), name='kategori_edit'),
    path('kategori/<int:pk>/hapus/', views.KategoriDeleteView.as_view(), name='kategori_hapus'),
